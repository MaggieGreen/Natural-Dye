...
class MainCollapsingToolbar extends StatefulWidget {
  MainCollapsingToolbar({Key key}) : super(key: key);
  @override
...
class _MainCollapsingToolbarState extends State<MainCollapsingToolbar> {
  var _material = [
    Material('Marigold petals', 'Fresh 4 cups or Dried 2 cups'),
    Material('Water', 'Enough to submerge petals'),
    Material('Alum', '2 tbsb'),
    Material('Fabric', 'colored cotton fabric'),
    Material('Cheese cloth', '50’’*50’’')
  ];
...
class Material {
  ...
  Material(this.name, this.subtitle);
}
